...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '金钻科技',   0, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '金钻', '18117002521', 'cartroyal@gmail.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '金钻', '00', 'cartroyal@gmail.com',  '18117002521', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'jz',    '金钻', '00', 'cartroyal@gmail.com',  '18837987610', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', '官网管理', '0', '0', 'web',               null, '', 1, 0, 'M', '0', '0', '', 'guide',      'admin', sysdate(), '', null, '官网管理目录');
insert into sys_menu values('5', '金钻官网', '0', '5', 'https://jzdia.com', null, '', 0, 0, 'M', '0', '0', '', 'guide',      'admin', sysdate(), '', null, '金钻官网地址');
-- 二级菜单
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 金钻新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 金钻系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
